    ...
    <main>
        ...
        if (!empty($_SESSION['student'])) {
            ...
            <form class="main_container" action="registrationHandler.php" method="post"> <!--Форма отправлки-->
                <span class="hidden" id="userRole">student</span> <!--Отвечает за динамическое отображение верхнего меню выбора-->
                <div class="main_container_header">
                    <div class="input_container_admin"> <!--Выбор роли пользователя сделан с костылями, необходимо когда-нибудь исправить-->
        ...
        <?
            ...
            <form class="main_container" action="registrationHandler.php" method="post">
                ...
                <div class="list_output_student_groups hidden ">
